namespace Computer_Info
{
    public partial class Form1 : Form
    {
        ...
        private void btndhcp_Click(object sender, EventArgs e)
        {
            ...
            lbl_dhcp_lan.Text= System.Net.Dns.GetHostName()+"_LAN { hardware ethernet " + lan + "; fixed address " + ip + ";}";
            lbl_dhcp_wlan.Text = System.Net.Dns.GetHostName() + "_WLAN { hardware ethernet " + wlan + "; fixed address " + ip + ";}";
